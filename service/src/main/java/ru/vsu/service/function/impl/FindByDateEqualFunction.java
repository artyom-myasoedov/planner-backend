...
@Component
public class FindByDateEqualFunction implements TetraFunction<Integer, Integer, Integer, List<EventType>, Collection<Event>> {
    ...
    public Collection<Event> apply(Integer year, Integer month, Integer day, List<EventType> eventTypes) {
        return repository.findByDay(year, month, day, eventTypes);
    }
}
